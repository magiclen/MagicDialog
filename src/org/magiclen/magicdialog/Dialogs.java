...
public class Dialogs implements Cloneable {
     ...
     * @return 再把對話框設定傳回
     */
    public Dialogs audio(final Audio audio) {
        if (audio == null) {
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        dialogs.audio(audio).fontSize(fontSize).owner(owner).message(message).header(header).title(title).type(type);
    ...
    private void playAudio() {
        ...
        switch (audio) {
            ...
            case DEFAULT:
                switch (type) {
                    case INFORMATION:
                        audioFileName = "mild.wav";
                        break;
                    case QUESTION:
                        audioFileName = "dududu.wav";
                        break;
                    case ERROR:
                        audioFileName = "hasty.wav";
                        break;
                    case WARNING:
                        audioFileName = "din.wav";
                        break;
                    default:
                        return;
                }
